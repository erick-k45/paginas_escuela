...
<a href="http://10.34.28.247/profin/LN/ger/con_sol.php"><img src='icon/consulta.png' width:"25%" height="25%"></a>
</center>
      ...
      <form method="post" id="form1"  action="http://10.34.28.247/profin/LN/ger/alt_sol.php" name="formregistro">
            <table id="fm">
              <tr valign="baseline">
