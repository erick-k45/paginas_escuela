...
<script type="text/javascript" src="http://10.34.28.247/profin/LN/emp/js/procli.js"></script>
...
<br>
<a href="http://10.34.28.247/profin/LN/emp/con_cli.php"><img src='icon/consulta.png' width:"25%" height="25%"></a>
</center>
      ...
      <form method="post" id="form1"  action="http://10.34.28.247/profin/LN/emp/bcli.php" enctype="">
            <table id="fm">
              <tr valign="baseline">
